...
namespace ns_control
{
    ...
    public:
		...
		printf("AllQuestion...\n");
            ...
            if (model_.GetAllQuesions(&all))
            {

		printf("AllQuestion...2222222222222222222222222222222\n");
		for(int i = 0; i < all.size(); i++){
            ...
            {
		printf("AllQuestion...22222222222223333333333333\n");
        ...
        void Judge(const std::string &number, const std::string in_json, std::string *out_json)
        {
            ...
            // debug
            std::cout << "post to compile: " << compile_string << std::endl;
